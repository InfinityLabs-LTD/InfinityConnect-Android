...
android {
    ...
    defaultConfig {
        ...
        // не применяется вовсе, приложение работает как раньше.
        //
        // Формат: пины через запятую, каждый — "sha256/BASE64" от
        // SubjectPublicKeyInfo. ВСЕГДА держать минимум два: текущий и запасной
        // (backup) ключ, иначе ротация сертификата сломает всех пользователей
        // до выката нового APK. Процедуру ротации и команду получения пина
        // см. в NetworkModule.kt.
        //
        // Пример:
        // buildConfigField("String", "INFINITY_CERT_PINS",
